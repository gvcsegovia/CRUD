                                ...
                                <div class="page-title-box">
                                    <div class="page-title-right">
                                        <ol class="breadcrumb m-0">
                                            <li class="breadcrumb-item"><a href="javascript: void(0);">DSWD Employee</a></li>

                                        </ol>
                                    </div>
                                    <h4 class="page-title">DSWD Employee</h4>
                                </div>
                            </div>
                        </div>     
                        <!-- end page title -->
...
<div class="card">
    ...
    <div class="tab-pane" id="settings">
        <form method="post" action="{{ route('employee.store') }}" enctype="multipart/form-data">
            ...
            <h5 class="mb-4 text-uppercase"><i class="mdi mdi-account-circle me-1"></i> DSWD Employee</h5>
