...
<html lang="en">
    ...
    <head>
        ...
        <!-- App favicon -->
        <link rel="shortcut icon" href="{{ asset('backend/assets/images/bagongpilipinas.png') }}">
    ...
    <body class="authentication-bg authentication-bg-pattern">
                                ...
                                <div class="text-center w-75 m-auto">
                                    <div class="auth-logo">
                                        <a href="index.html" class="logo logo-dark text-center">
                                            <span class="logo-lg">
                                                <img src="{{ asset('backend/assets/images/logo new.png') }}" alt="" height="30">
                                            </span>
                                        </a>
        ...
        <script>document.write(new Date().getFullYear())</script> &copy; DSWD <a href="" class="text-white-50">Black Swan</a> 
        </footer>
